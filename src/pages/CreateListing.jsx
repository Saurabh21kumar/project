    ...
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <input onChange={handleChange} value={formData.name} type="text" placeholder='Name' className='border p-3 rounded-lg' id='name' maxLength='62' minLength='3' required />
          ...
          <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <input type="number" id='RegularPrice' min='10' max='1000000' required className='p-3 border-gray-300 rounded-lg' onChange={handleChange} value={formData.regularPrice} />
            ...
            <div className='flex items-center gap-2'>
              <input type="number" id='DiscountedPrice' min='10' max='1000000' required className='p-3 border-gray-300 rounded-lg' onChange={handleChange} value={formData.discountPrice} />
              <div className='flex flex-col items-center'>
          ...
          <p className='text-red-700 text-sm' >{imageUploadError && imageUploadError}</p>
          {
            formData.imageUrls?.length > 0 && formData.imageUrls.map((url, index) => {
              <div key={url} className='flex justify-between p-3 border items-center'>
                ...
                <button type='button' onClick={() => handleImageSubmit(index)} className='p-3 text-red-700 rounded-lg uppercase hover:opacity-60'>Delete</button>
              </div>
            })
          }
